...
export interface ApiCompanyLandingPageCompanyLandingPage
  ...
  info: {
    description: '';
    displayName: 'company-landing-page';
    pluralName: 'company-landing-pages';
    singularName: 'company-landing-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    aboutSection: Schema.Attribute.Component<
      'about-section-props.about-section',
      false
    >;
    cancellationRefundPolicies: Schema.Attribute.Component<
      'cancellation-refund-policies-props.cancellation-refund-policies',
      false
    >;
    contactUs: Schema.Attribute.Component<'contact-us-props.contact-us', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqSection: Schema.Attribute.Component<
      'faq-section-props.faq-section',
      false
    >;
    featureSection: Schema.Attribute.Component<
      'feature-section-props.feature-section',
      false
    >;
    footerSection: Schema.Attribute.Component<
      'footer-section-props.footer-section',
      false
    >;
    heroSection: Schema.Attribute.Component<
      'hero-section-props.hero-section',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-landing-page.company-landing-page'
    > &
      Schema.Attribute.Private;
    navbarSection: Schema.Attribute.Component<
      'navbar-section-props.navbar-section',
      false
    >;
    newsletterSection: Schema.Attribute.Component<
      'newsletter-section-props.newsletter-section',
      false
    >;
    pricingSection: Schema.Attribute.Component<
      'pricing-section-props.pricing-section',
      false
    >;
    privacyPolicy: Schema.Attribute.Component<
      'privacy-policy-props.privacy-policy',
      false
    >;
    projectSection: Schema.Attribute.Component<
      'project-section-props.project-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    serviceSection: Schema.Attribute.Component<
      'service-section-props.service-section',
      false
    >;
    teamSection: Schema.Attribute.Component<
      'team-section-props.team-section',
      false
    >;
    termsOfService: Schema.Attribute.Component<
      'terms-of-service-props.terms-of-service',
      false
    >;
    testimonialSection: Schema.Attribute.Component<
      'testimonial-section-props.testimonial-section',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiDocDoc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    project: Schema.Attribute.Enumeration<
      ['company-landing-page', 'project-1', 'project-2']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID & Schema.Attribute.Required;
