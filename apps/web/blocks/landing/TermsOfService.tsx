...
const TermsOfService = () => {
    ...
    const tableOfContents = [
        ...
        { id: "third-party-links", label: "Third-Party Links & Ads" },
        { id: "disclaimers", label: "Disclaimers" },
        { id: "limitation-liability", label: "Limitation on Liability" },
        { id: "term-termination", label: "Term and Termination" },
        { id: "copyright-policy", label: "Copyright Policy" },
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            ...
            >
                <p className="mb-4 text-xs opacity-50">Version {data.termsOfService.version}</p>
                <p className="mb-4">
                    The {data.termsOfService.siteName} website located at <a href={data.termsOfService.websiteUrl} className="text-primary underline hover:text-primary/80">
                        {data.termsOfService.websiteUrl}
                    </a> is a copyrighted work belonging to {data.termsOfService.companyLegalName}. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.
                </p>
                ...
                <h2 id="access-site">Access to the Site</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    This component only includes part of the Terms of Use due to length. For the full Terms of Use, please refer to the original document.
                </p>

                <h2 id="third-party-links">Third-Party Links & Ads; Other Users</h2>
                ...
                <p className="mb-4">
                    <strong>Cookies and Web Beacons. </strong> Like any other website, Personal Automation Dashboard uses ‘cookies’. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.
                </p>
                ...
                <h3 id="limitation-liability">Limitation on Liability</h3>
                <p className="mb-4">
                ...
                <h2 id="term-termination">Term and Termination</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    <strong>Notice Requirement and Informal Dispute Resolution</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: Domalguda, Near AV College. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
                </p>
                ...
                <p className="mb-4">
                    <strong>Your Privacy</strong> Please read Privacy Policy.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    Address: {data.termsOfService.address}
                </p>
                <p className="mb-4">
                    Email: {data.termsOfService.supportEmailAddress}
                </p>
            </LegalPageLayout>
        </div>
    )
