...
const PrivacyPolicy = () => {
    ...
    const tableOfContents = [
        ...
        { id: "collecting-data", label: "Collecting & Using Data" },
        { id: "retention-data", label: "Retention of Data" },
        { id: "transfer-data", label: "Transfer of Data" },
        { id: "delete-data", label: "Delete Your Data" },
        { id: "disclosure-data", label: "Disclosure of Data" },
        { id: "security-data", label: "Security" },
        { id: "childrens-privacy", label: "Children's Privacy" },
        { id: "links-other-websites", label: "Links to Other Websites" },
        { id: "changes-policy", label: "Changes to Policy" },
        ...
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            ...
            >
                ...
                <ul>
                    ...
                    <li><strong>Company:</strong> Refers to {data.privacyPolicy.companyLegalName}, also referred to as "We," "Us," or "Our" in this Agreement.</li>
                    <li><strong>Cookies:</strong> Small files placed on Your device by a website, containing details of Your browsing history among its many uses.</li>
                    <li><strong>Country:</strong> Refers to {data.privacyPolicy.country}.</li>
                    ...
                    <li><strong>Website:</strong> Refers to {data.privacyPolicy.siteName}, accessible from <a href={data.privacyPolicy.websiteUrl} className="text-primary underline hover:text-primary/80">{data.privacyPolicy.websiteUrl}</a>.</li>
                ...
                <h2 id="collecting-data">Collecting and Using Your Personal Data</h2>
                ...
                <p>
                    The Company allows You to create an account and log in through Third-party Social Media Services such as Google, Facebook, Instagram, Twitter, and LinkedIn.
                </p>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        <strong>To provide You with news and offers:</strong> Special offers and general information about other goods, services, and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
                    </li>
                    <li>
                ...
                <h2 id="retention-data">Retention of Your Personal Data</h2>
                <p>
                ...
                <h2 id="transfer-data">Transfer of Your Personal Data</h2>
                <p>
                ...
                <h2 id="delete-data">Delete Your Personal Data</h2>
                <p>
                ...
                <h2 id="disclosure-data">Disclosure of Your Personal Data</h2>
                ...
                <h2 id="security-data">Security of Your Personal Data</h2>
                <p>
                ...
                <h2 id="changes-policy">Changes to this Privacy Policy</h2>
                <p>
                ...
                <ul>
                    <li>
                        By email:{' '}
                        <a
                            href={`mailto:${data.privacyPolicy.supportEmailAddress}`}
                            className="text-primary underline hover:text-primary/80"
                        >
                            {data.privacyPolicy.supportEmailAddress}
                        </a>
                    </li>
                </ul>
            </LegalPageLayout>
