...
export const landingRouter = createTRPCRouter({
  getLandingInfoFromNotion: baseProcedure.query(async () => {
  ...
  updateLandingInfo: baseProcedure
    ...
    .mutation(async ({ input }) => {
        ...
        filters: [
          {
            ...
            type: "title",
            condition: "contains",
            value: process.env.NEXT_PUBLIC_SAAS_NAME!,
          },
        ],
      ...
      if (!landingPageData)
        throw new Error("Landing Page Notion entry not found");
      ...
      if (input.title !== undefined)
        properties.push({ name: "title", type: "title", value: input.title });
      if (input.logo !== undefined)
        properties.push({ name: "logo", type: "file_url", value: input.logo });
      if (input.darkLogo !== undefined)
        properties.push({
          name: "darkLogo",
          type: "file_url",
          value: input.darkLogo,
        });
      ...
      if (input.githubRepositoryName !== undefined)
        properties.push({
          name: "githubRepositoryName",
          type: "text",
          value: input.githubRepositoryName,
        });
      if (input.donateNowLink !== undefined)
        properties.push({
          name: "donateNowLink",
          type: "url",
          value: input.donateNowLink,
        });
      ...
      if (input.appointmentLink !== undefined)
        properties.push({
          name: "appointmentLink",
          type: "url",
          value: input.appointmentLink,
        });
      if (input.codeSnippet !== undefined)
        properties.push({
          name: "codeSnippet",
          type: "text",
      ...
      if (input.about !== undefined)
        properties.push({ name: "about", type: "text", value: input.about });
      if (input.users !== undefined)
        properties.push({ name: "users", type: "number", value: input.users });
      if (input.subscribers !== undefined)
        properties.push({
          name: "subscribers",
          type: "number",
          value: input.subscribers,
        });
      ...
      if (input.productsCount !== undefined)
        properties.push({
          name: "products",
          type: "number",
          value: input.productsCount,
        });

      if (input.serviceHeading !== undefined)
        properties.push({
          name: "serviceHeading",
          type: "text",
          value: input.serviceHeading,
        });
      ...
      if (input.productHeading !== undefined)
        properties.push({
          name: "productHeading",
          type: "text",
          value: input.productHeading,
        });
      ...
      if (input.testimonialHeading !== undefined)
        properties.push({
          name: "testimonialHeading",
          type: "text",
          value: input.testimonialHeading,
        });
      if (input.testimonialDescription !== undefined)
        properties.push({
          name: "testimonialDescription",
          type: "text",
          value: input.testimonialDescription,
        });
      if (input.teamHeading !== undefined)
        properties.push({
          name: "teamHeading",
          type: "text",
          value: input.teamHeading,
        });
      if (input.teamDescription !== undefined)
        properties.push({
          name: "teamDescription",
          type: "text",
          value: input.teamDescription,
        });
      ...
      if (input.creatorLink !== undefined)
        properties.push({
          name: "creatorLink",
          type: "url",
          value: input.creatorLink,
        });
      if (input.supportEmailAddress !== undefined)
        properties.push({
          name: "supportEmailAddress",
          type: "text",
          value: input.supportEmailAddress,
        });
      if (input.companyLegalName !== undefined)
        properties.push({
          name: "companyLegalName",
          type: "text",
          value: input.companyLegalName,
        });
      ...
      async function syncArray<T extends { id?: string }>(
        ...
        console.log(
          `[syncArray] dbId=${dbId}, items count=${items?.length ?? "undefined"}`,
        );
        ...
        // Trash removed
        const toTrash = currentIds.filter(
          (id: string) => !inputIds.includes(id),
        );
      ...
      await syncArray(process.env.PRODUCT_DATABASE_ID, input.products, (p) =>
        [
          ...
          { name: "Github Link", type: "url", value: p.githubLink || "" },
          {
            ...
            type: "url",
            value: p.npmPackageLink || "",
          },
          {
            name: "Github Repo Stars",
            type: "number",
            value: p.githubRepoStarts || 0,
          },
          {
            name: "Weekly Github Clones",
            type: "number",
            value: p.weeklyGithubClones || 0,
          },
          {
            name: "Weekly Npm Downloads",
            type: "number",
            value: p.weeklyNpmDownloads || 0,
          },
          {
            name: "Notion Template Link",
            type: "url",
            value: p.notionTemplateLink || "",
          },
          { name: "Notion Views", type: "number", value: p.notionViews || 0 },
          {
            name: "Notion Downloads",
            type: "number",
            value: p.notionDownloads || 0,
          },
          ...
          { name: "Website Views", type: "number", value: p.websiteViews || 0 },
          {
            ...
            type: "number",
            value: p.monthlyActiveUsers || 0,
          },
          {
            name: "Youtube Video Link",
            type: "url",
            value: p.youtubeVideoLink || "",
          },
      ...
      // Sync testimonials
      await syncArray(
        process.env.TESTIMONIAL_DATABASE_ID,
        input.testimonials,
        (t) => [
